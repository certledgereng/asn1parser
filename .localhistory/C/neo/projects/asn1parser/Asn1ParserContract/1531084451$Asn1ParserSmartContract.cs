    ...
    namespace Asn1ParserContract
    {
        ...
        public class Asn1ReaderT
        {
            ...
            static void ParseNestedType(Asn1Reader asn1Reader)
            {
                ...
                Storage.Put(Storage.CurrentContext, "asn1Reader.Tag", );
                ...
                bool tagValue = asn1Reader.excludedTags[tag];
                Storage.Put(Storage.CurrentContext, "tagValue", tagValue.ToString());
