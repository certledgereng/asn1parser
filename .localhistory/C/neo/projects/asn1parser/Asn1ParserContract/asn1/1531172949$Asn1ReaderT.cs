...
namespace Asn1ParserContract.asn1
{
    ...
    {
        public static void initMembers(Asn1Data asn1Reader)
        {
        ...
        public static Asn1Data ParseFromRawData(byte[] rawData)
        {
            ...
            Asn1Data asn1Reader = FromRawData(rawData, 0);
        ...
        public static Asn1Data FromRawData(Byte[] rawData, Int32 offset)
        {
            ...
            Asn1Data asn1Reader = new Asn1Data();
        ...
        public static void Initialize(Asn1Data asn1Reader, Byte[] raw, Int32 pOffset)
        {
        ...
        static void CalculateLength(Asn1Data asn1Reader)
        {
        ...
        static void GetTagName(Asn1Data asn1Reader, Byte tag)
        {
        ...
        static void ParseNestedType(Asn1Data asn1Reader)
        {
        ...
        static PredictResult Predict(Asn1Data asn1Reader, Int64 start, Int32 projectedLength, bool assignMap)
        {
        ...
        static Int64 CalculatePredictLength(Asn1Data asn1Reader, Int64 offset)
        {
        ...
        static Boolean MoveAndExpectTypesWithMoveNextCurrentLevel(Asn1Data asn1Reader, params Byte[] expectedTypes)
        {
        ...
        static void MoveAndExpectTypesWithMoveNext(Asn1Data asn1Reader, params Byte[] expectedTypes)
        {
        ...
        public static Byte[] GetHeader(Asn1Data asn1Reader)
        {
        ...
        public static Byte[] GetPayload(Asn1Data asn1Reader)
        {
        ...
        public static Byte[] GetTagRawData(Asn1Data asn1Reader)
        {
        ...
        public static Int32 GetNestedNodeCount(Asn1Data asn1Reader)
        {
            return asn1Reader.IsConstructed ? asn1Reader.childCount : 0;
        }
        public static Boolean MoveNext(Asn1Data asn1Reader)
        {
        ...
        public static void MoveNextAndExpectTags(Asn1Data asn1Reader, params Byte[] expectedTags)
        {
            MoveAndExpectTypesWithMoveNext(asn1Reader, expectedTags);
        }
        public static Boolean MoveNextCurrentLevel(Asn1Data asn1Reader)
        {
        ...
        public static void MoveNextCurrentLevelAndExpectTags(Asn1Data asn1Reader, params Byte[] expectedTags)
        {
            MoveAndExpectTypesWithMoveNextCurrentLevel(asn1Reader, expectedTags);
        }
        public static Boolean MoveToPoisition(Asn1Data asn1Reader, Int32 newPosition)
        {
        ...
        public static void Reset(Asn1Data asn1Reader)
        {
            asn1Reader.currentPosition = asn1Reader.offsetMap[0];
            Initialize(asn1Reader, null, 0);
        }
        public static Int32 BuildOffsetMap(Asn1Data asn1Reader)
        {
            Reset(asn1Reader);
    ...
    public class Asn1GeneralizedTime
    {
        ...
        static Asn1Data Decode(Asn1Data asn1Reader, Asn1GeneralizedTime asn1GeneralizedTime)
        {
        ...
        static void Init(Asn1Data asn1Reader, Asn1GeneralizedTime asn1GeneralizedTime)
        {
            asn1GeneralizedTime.Tag = asn1Reader.Tag;
            asn1GeneralizedTime.TagName = asn1Reader.TagName;
            asn1GeneralizedTime.RawData = Asn1Parser.GetTagRawData(asn1Reader);
        }
        ...
        public static long Decode(Asn1Data asn1Reader)
        {
